<template>
    <n-layout has-sider content-style="display: flex; flex-flow: row nowrap; width: 100%;">
        <n-layout-sider collapse-mode="width" :collapsed-width="60" :width="200" show-trigger="arrow-circle" bordered @collapse="collapsed = true" @expand="collapsed = false" :collapsed="collapsed">
            <n-menu :collapsed="collapsed" :collapsed-width="64" :collapsed-icon-size="22" :options="menuOptions" v-model:value="activeKey" />
        </n-layout-sider>
