            ...
            <div class="right">
                ...
                <n-form class="form" label-placement="left" ref="formRef" :model="modelRef" :rules="rules">
                    <n-form-item path="model.username" label="">
                        <n-input placeholder="请输入账号" v-model:value="modelRef.model.username" @keydown.enter.prevent />
                    </n-form-item>
                    <n-form-item path="password" label="">
                        <n-input v-model:value="modelRef.model.password" @input="handlePasswordInput" type="password" @keydown.enter.prevent placeholder="请输入密码" />
                    </n-form-item>
                    <n-form-item first path="reenteredPassword" label="" ref="rPasswordFormItemRef">
                        <n-input v-model:value="modelRef.model.reenteredPassword" type="password" @keydown.enter.prevent placeholder="请输入验证码" />
                    </n-form-item>
                </n-form>
